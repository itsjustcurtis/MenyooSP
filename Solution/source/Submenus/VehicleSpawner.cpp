...
#pragma region vehicle bmps
		...
		std::vector<VehBmpSprite> vVehicleBmps{
			...
			{ VEHICLE_ANNIHILATOR2,	"candc_dlc_heist4", "annihlator2" },
			{ VEHICLE_AVISA,			"candc_dlc_heist4", "avisa" },
			{ VEHICLE_DINGHY5,		"candc_dlc_heist4", "dinghy5" },
			{ VEHICLE_MANCHEZ2,		"candc_dlc_heist4", "manchez2" },
			{ VEHICLE_PATROLBOAT,		"candc_dlc_heist4", "patrolboat" },
			{ VEHICLE_SEASPARROW2,	"candc_dlc_heist4", "sparrow3" },
			{ VEHICLE_SEASPARROW3,	"candc_dlc_heist4", "sparrow3" },
			{ VEHICLE_SQUADDIE,		"candc_dlc_heist4", "squaddie" },
			{ VEHICLE_TOREADOR,		"candc_dlc_heist4", "toreador" },
			{ VEHICLE_VERUS,			"candc_dlc_heist4", "verus" },
			{ VEHICLE_VETIR,			"candc_dlc_heist4", "vetir" },
			{ VEHICLE_WINKY,			"candc_dlc_heist4", "winky" },
			...
			{ VEHICLE_BALLER8,		"lgm_dlc_2023_2", "veh" },
			{ VEHICLE_TURISMO3,		"lgm_dlc_2023_2", "veh" },
			...
			{ VEHICLE_ASTEROPE2,		"sssa_dlc_2023_2", "astrope2" },
