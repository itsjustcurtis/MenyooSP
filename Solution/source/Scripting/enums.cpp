...
namespace ControllerInputs {
	const std::vector<std::string> vNames
	{
			...
			"CREATOR_ACCEPT",
			"CREATOR_DELETE",
			"CREATOR_SWITCH_CAMERA",
			"CREATOR_TOGGLE_ORBIT_CAMERA",
			"CREATOR_CAMERA_DECREASE",
			"CREATOR_CAMERA_INCREASE",
			"CREATOR_MENU_ACCEPT",
			"CREATOR_MENU_CANCEL",
			"CREATOR_FAST_ADJUST",
			"CREATOR_FINE_ADJUST",
			"CREATOR_FAST_ZOOM",
			"CREATOR_LIST",
			"CREATOR_ALT_MENU_ENTRY",
			"CREATOR_WARP_AND_EDIT",
			"CREATOR_TAB_LEFT",
			"CREATOR_TAB_RIGHT",
			"CREATOR_ROTATE_LEFT",
			"CREATOR_ROTATE_RIGHT",
			"CREATOR_FOV_INCREASE",
			"CREATOR_FOV_DECREASE",
			"CREATOR_EXTRA_OPTIONS1",
			"CREATOR_EXTRA_OPTIONS2",
			"CREATOR_CONTEXT_MENU",
			"CREATOR_MENU_UP",
			"CREATOR_MENU_DOWN",
			"CREATOR_ADJUST_LEFT",
			"CREATOR_ADJUST_RIGHT",
			"CREATOR_RESET_FOV",
			"CREATOR_ENTITY_RAISE",
			"CREATOR_ENTITY_LOWER",
			"CREATOR_TOGGLE_DESCRIPTIONS",
			"CREATOR_MENU",
			"CREATOR_MENU_DELETE",
			"CREATOR_MOVE_LR",
			"CREATOR_MOVE_UD",
			"CREATOR_MOVE_UP_ONLY",
			"CREATOR_MOVE_DOWN_ONLY",
			"CREATOR_MOVE_LEFT_ONLY",
			"CREATOR_MOVE_RIGHT_ONLY",
			"ATTACK2",
			"RAPPEL_JUMP",
			"RAPPEL_LONG_JUMP",
			"RAPPEL_SMASH_WINDOW",
