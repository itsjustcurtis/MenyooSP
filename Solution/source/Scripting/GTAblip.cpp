...
namespace BlipIcon {
	const std::map<int, std::string> vNames
	{
		...
		{ BlipIcon::Dinghy2, "Weaponized Dingy" },
		...
		{ BlipIcon::RappelGear, "RappelGear" },
		{ BlipIcon::KeyCard, "KeyCard" },
		{ BlipIcon::Password, "Password" },
		{ BlipIcon::IslandHeist, "IslandHeist" },
		{ BlipIcon::IslandParty, "IslandParty" },
		{ BlipIcon::RadarTower, "RadarTower" },
		{ BlipIcon::UnderwaterGrate, "UnderwateGrate" },
		{ BlipIcon::PowerSwitch, "PowerSwitch" },
		{ BlipIcon::CompoundGate, "CompoundGate" },
		{ BlipIcon::Painting, "Painting" },
		{ BlipIcon::AutoShop, "AutoShop" },
		{ BlipIcon::Anchor, "Anchor" },
		{ BlipIcon::PrizeBox, "PrizeBox" },
		{ BlipIcon::ChopShopHeist, "ChopShopHeist" },
		{ BlipIcon::Securoserv, "SecuroServ" },
		{ BlipIcon::MovieCollection, "MovieCollection" },
		{ BlipIcon::Chalkboard, "Chalkboard" },
		{ BlipIcon::Train, "Train" },
		{ BlipIcon::Slamvan2, "LostMCSlamvan" },
		{ BlipIcon::Crusader, "Crusader" },
		{ BlipIcon::ConstructionOutfit, "ConstructionOutfit" },
		{ BlipIcon::VanKeys, "VanKeys" },
		{ BlipIcon::SUVService, "SUVService" },
		{ BlipIcon::SecurityContract, "SecurityContract" },
		...
		{ BlipIcon::BikerBar, "BikerBar" },
		{ BlipIcon::FlamingSkull, "FlamingSkull" },
		{ BlipIcon::CayoPerico, "CayoPerico" },
		{ BlipIcon::ClubhouseContract, "ClubhouseContract" },
		{ BlipIcon::Acid, "Acid" },
		{ BlipIcon::AcidLab, "AcidLab" },
		{ BlipIcon::MysteryPackage, "MysteryPackage" },
		{ BlipIcon::GunVan, "GunVan" },
		{ BlipIcon::Tractor, "Tractor" },
		{ BlipIcon::JuggaloWarehouse, "JuggaloWarehouse" },
		...
		{ BlipIcon::WeaponizedConada, "WeaponizedConada" },
		{ BlipIcon::Streamer216, "Streamer216" },
		{ BlipIcon::SignalJammer, "SignalJammer" },
		{ BlipIcon::SalvageYard, "SalvageYard" },
		{ BlipIcon::SalvageYardHeist, "SalvageYardHeist" },
		{ BlipIcon::SalvageYardPlans, "SalvageYardPlans" },
		{ BlipIcon::WeaponCrate, "WeaponCrate" },
		{ BlipIcon::Snowball, "Snowball" },
		{ BlipIcon::Tombstone, "Tombstone" },
		{ BlipIcon::BottomDollarBounty, "BottomDollarBounty" },
		{ BlipIcon::BottomDollarBountyTarget, "BottomyDollarBountyTarget" },
		{ BlipIcon::FilmingSchedule, "FilmingSchedule" },
		{ BlipIcon::Pizza, "Pizza" },
		{ BlipIcon::AircraftCarrier, "AircraftCarrier" },
		{ BlipIcon::BottomDollarBailEnforcement, "BottomDollarBailEnforcement" },
		{ BlipIcon::ZombieDisease, "ZombieDisease" },
		{ BlipIcon::ZombieProximity, "ZombieProximity" },
		{ BlipIcon::ZombieFire, "ZombieFire" },
		{ BlipIcon::PossessedAnimal, "PossessedAnimal" },
		{ BlipIcon::MobilePhone, "MobilePhone" },
	};
}
